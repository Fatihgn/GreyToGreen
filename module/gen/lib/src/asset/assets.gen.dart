...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/loading_anim.json
  LottieGenImage get loadingAnim =>
      const LottieGenImage('assets/animations/loading_anim.json');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [applogo, forest, googleicon];
}
